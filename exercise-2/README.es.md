...
1. Vamos a darle una vuelta. Abri la aplicación con VSCode o el IDE de tu preferencia y navegue a la carpeta **src/App.tsx**.

> **Nota:** _Protip!_ Se puede abrir VSCode usando la terminal ejecutando `code .` en la carpeta donde este el codigo. Del mismo modo, podría hacer lo mismo para Atom con `atom .`. Y para Sublime, puede ejecutar `subl .`.
